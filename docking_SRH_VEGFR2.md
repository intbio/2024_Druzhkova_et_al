  ...
  <script>
   ...
   peptide_reps = [];
    ...
    var arrayLength = names.length;
        ...
        document.write(`<tr><td> <input type="checkbox" id="${i}" name="${models[i]}"></td><td> ${galaxy_scores[i]} </td><td> ${energies[i]} </td><td> <a href="docking_str/${names[i]}" download>PDB</a> </td></tr>`); 
			}
