  ...
  <script>
   ...
   peptide_reps = [];
    ...
    var arrayLength = names.length;
        ...
        document.write(`<tr><td> <input type="checkbox" id="${i}" name="${models[i]}"></td><td> ${galaxy_scores[i]} </td><td> ${energies[i]} </td><td> <a href="https://github.com/intbio/2024_TRAIL_MD/tree/main/docking_str/${names[i]}" download></a> </td></tr>`); 
			}
